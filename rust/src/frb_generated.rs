...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 877572458;
...
fn wire__crate__api__btc_ln__btc_ln_swap_tx_size_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_dco::<_, _, crate::api::error::BoltzError>((move || {
                    let output_ok = crate::api::btc_ln::BtcLnSwap::tx_size(&api_that)?;
                    Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__lbtc_ln__lbtc_ln_swap_tx_size_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_dco::<_, _, crate::api::error::BoltzError>((move || {
                    let output_ok = crate::api::lbtc_ln::LbtcLnSwap::tx_size(&api_that)?;
                    Ok(output_ok)
                })())
            }
        },
...
mod io {
    ...
    #[no_mangle]
    pub extern "C" fn frbgen_boltz_dart_cst_new_box_autoadd_btc_ln_swap(
    ) -> *mut wire_cst_btc_ln_swap {
    ...
    #[no_mangle]
    pub extern "C" fn frbgen_boltz_dart_cst_new_box_autoadd_lbtc_ln_swap(
