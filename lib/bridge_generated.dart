...
class BoltzDartImpl implements BoltzDart {
  ...
  Future<PreImage> preimageRandomStaticMethodApi({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_preimage_random__static_method__Api(port_),
      parseSuccessData: _wire2api_pre_image,
      parseErrorData: null,
      constMeta: kPreimageRandomStaticMethodApiConstMeta,
      argValues: [],
      hint: hint,
    ));
  }

  FlutterRustBridgeTaskConstMeta get kPreimageRandomStaticMethodApiConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "preimage_random__static_method__Api",
        argNames: [],
      );
...
class BoltzDartWire implements FlutterRustBridgeWireBase {
  ...
  void wire_preimage_random__static_method__Api(
    int port_,
  ) {
    return _wire_preimage_random__static_method__Api(
      port_,
    );
  }

  late final _wire_preimage_random__static_method__ApiPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_preimage_random__static_method__Api');
  late final _wire_preimage_random__static_method__Api =
      _wire_preimage_random__static_method__ApiPtr
