...
class LbtcLnSwap {
  ...
  Future<void> coopCloseSubmarine() => BoltzCore.instance.api
      .crateApiLbtcLnLbtcLnSwapCoopCloseSubmarine(that: this);
  ...
  Future<String> getCompletedSubmarinePreimage() => BoltzCore.instance.api
      .crateApiLbtcLnLbtcLnSwapGetCompletedSubmarinePreimage(that: this);

  /// Get the preimage of the lightning invoice for a submarine swap
  Future<String> getPreimage() =>
      BoltzCore.instance.api.crateApiLbtcLnLbtcLnSwapGetPreimage(that: this);
  ...
  Future<String> toJson() =>
      BoltzCore.instance.api.crateApiLbtcLnLbtcLnSwapToJson(that: this);
